...
chrome.webRequest.onHeadersReceived.addListener((details) => {
  ...
  const isReqUrl  = lodash__WEBPACK_IMPORTED_MODULE_0__["startsWith"](initUrl, baseUrl);
  const isWantUrl =
    lodash__WEBPACK_IMPORTED_MODULE_0__["startsWith"](url, 'http://101.79.136.27/') ||
    lodash__WEBPACK_IMPORTED_MODULE_0__["startsWith"](url, 'http://101.79.136.36/') ||
    lodash__WEBPACK_IMPORTED_MODULE_0__["startsWith"](url, 'http://211.110.86.208/') ||
    lodash__WEBPACK_IMPORTED_MODULE_0__["startsWith"](url, 'http://vod-archive-kr-cdn-z01.afreecatv.com/') ||
    lodash__WEBPACK_IMPORTED_MODULE_0__["startsWith"](url, 'https://storage.googleapis.com/aengzi.com/')
;
