...
let date = moment__WEBPACK_IMPORTED_MODULE_1___default.a.utc().format('YYYY-MM-DD HH:mm:ss');

chrome.instanceID.getID((instanceId) => {
  const device = axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('http://1-1-0.api.aengzi.com/devices', {
    related_id: instanceId,
    related_type: 'chrome',
  });
  setInterval(() => {
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.patch('http://1-1-0.api.aengzi.com/devices/'+device.id, {
      related_id: instanceId,
      related_type: 'chrome',
    });
    const notificationList = axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('http://1-1-0.api.aengzi.com/notifications', {
      params: {
        after: date,
      }
    });
    ...
    date = moment__WEBPACK_IMPORTED_MODULE_1___default.a.utc().format('YYYY-MM-DD HH:mm:ss');
  }, 3600 * 1000);
});
