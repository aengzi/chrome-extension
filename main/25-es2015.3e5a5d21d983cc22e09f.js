...
/* harmony import */ var _lol_game_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./lol-game.component */ "ULcP");
...
let LolGameVodPlayerModule = class LolGameVodPlayerModule {
};
LolGameVodPlayerModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
        declarations: [
            _lol_game_component__WEBPACK_IMPORTED_MODULE_7__["LolGameVodPlayerComponent"]
        ],
        exports: [
            _lol_game_component__WEBPACK_IMPORTED_MODULE_7__["LolGameVodPlayerComponent"]
        ],
        ...
        providers: [{
                ...
                useValue: (snapshot) => {
                    return src_app_service_http_service__WEBPACK_IMPORTED_MODULE_8__["HttpService"].api().get('lol-games/' + snapshot.params.id, {
                        ...
                        const timelines = lodash__WEBPACK_IMPORTED_MODULE_1__["chain"](game.getRelations().timelines).orderBy([(timeline) => timeline.getAttrs().elapsed_timestamp], ['asc']).value();
                ...
                useFactory: (game$$) => {
                    return (snapshot) => {
                        return game$$(snapshot).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((game) => {
                            ...
                            const player = lodash__WEBPACK_IMPORTED_MODULE_1__["chain"](matches.participants).filter((participant) => {
                                return participant.participantId == game.getAttrs().participant_id;
                            }).first().value();
                            const myTeam = lodash__WEBPACK_IMPORTED_MODULE_1__["chain"](matches.teams).filter((team) => {
                                return team.teamId == player.teamId;
                            }).first().value();
                            const otherTeam = lodash__WEBPACK_IMPORTED_MODULE_1__["chain"](matches.teams).filter((team) => {
                                return team.teamId == player.teamId;
                            }).first().value();
                            return {
                                player: player,
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_lol_game_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./lol-game.component.html */ "+arj");
/* harmony import */ var _lol_game_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./lol-game.component.scss */ "wzKo");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "tyNb");
...
let LolGameVodPlayerComponent = class LolGameVodPlayerComponent {
    constructor(route) {
...
LolGameVodPlayerComponent.ctorParameters = () => [
...
LolGameVodPlayerComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
